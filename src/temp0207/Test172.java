...
public class Test172 {
    ...
    private static final String[] names = {"이연주", "이호석", "김태형", "김민성", "최문정", "이시우"};

    private static final String[] tels = {"010-4423-0463", "010-9600-1715", "010-9768-3110", "010-5154-6322", "010-2877-0992", "010-4428-9420"};
    ...
    public static void main(String[] args)
    {
        ...
        // ht라는 Hashtable 자료구조에 배열(name, tels)에 담겨있는
        // 데이터를 요소로 담아내기
        // -> put(k, v);
        ...
        // ht라는 Hashtable 의 값을... key 를 이용하여 검색
        // -> get(k)
        ...
        // ht 라는 Hashtable 자료그주에서 ⌜김민성⌟ 데이터 삭제
        // -> remove()
        ht.remove("김민성");
        ...
        //ht.put("홍은혜", null);            //-- value 가 null
        //--==>> 러타임 에러
        //  NullPointerException
        //ht.put(null, "010-1234-2345");     //-- key가 null
        //--==>> 러타임 에러
        //  NullPointerException
